...
public class GameView extends View{
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(String.valueOf(time), ballance*20, ballance*75, paint.borderMiddleText());
        canvas.drawText(String.valueOf(moveNumber), width - ballance * 60, ballance*75, paint.borderMiddleText());
        /* Game Text Bitiş */
